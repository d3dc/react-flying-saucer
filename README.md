...
- 🔋 Batteries included! - suspense, contextual constants, scoped route trees, dynamic models, and enhanced [routing components](https://github.com/ReactTraining/react-router)
